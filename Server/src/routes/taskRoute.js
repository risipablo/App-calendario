...
const { getTask, addTask, addMoreTask, deleteTask, deleteSubTask, deleteAllTask, completeSubTask, editSubtask, completeAllTask, completePrincipalTask, saveTask, incompleteSubTask, deleteTasksByFilter } = require('../controllers/taskController')
...
router.delete('/task/filter', protect, deleteTasksByFilter)
