...
const { getGoal, addGoal, deleteGoal, deleteAllGoal, saveGoal, completedGoal, deleteGoalFilter } = require('../controllers/goalController')
const { protect } = require('../middleware/authMiddleware')
const router = express.Router()

router.get('/goal', protect, getGoal)
router.post('/goal', protect,addGoal)
router.delete('/goal/filter', protect, deleteGoalFilter )
