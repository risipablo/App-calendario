...
export const CalendarContainer = ({
    ...
    const handleAddNewEvent = () => {
        ...
        if (onAddEventFromModal) {
            onAddEventFromModal({
                title: newEventTitle.trim(),
                date: newEventDate,
                category: newEventCategory || 'otros',
    ...
    return (
        <div className="calendar-container">
            <div className="filter-buttons-group">
                ...
                {hasActiveFilter && (
                    <button className="btn-toggle-view btn-reset" onClick={handleClearFilter}>
                        <RotateCcw size={18} />
                        Limpiar filtro
                    </button>
                )}
            ...
            {showAddModal && (
                <div className="modal-overlay-calendar" onClick={() => {
                    setShowAddModal(false)
                    resetNewEventForm()
                }}>
                    <div className="modal-content-calendar" onClick={(e) => e.stopPropagation()}>
                        <div className="modal-header-calendar">
                            <h3>Agregar Evento - {formatDateDisplay(new Date(newEventDate))}</h3>
                        ...
                        <div className="modal-body-calendar">
                            ...
                            <div className="modal-actions-inline">
                                <button
                                    ...
                                    disabled={!newEventTitle.trim() || !newEventDate || !newEventHour}
                                >
                                    Guardar
                                </button>
                                <button
